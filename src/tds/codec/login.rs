...
///                          FedAuthToken
///                          [OtherData]
/// bFedAuthLibrary: 7 bits, collectively treated as a 7-bit unsigned integer, indicating the library
///     that is used by the client for federated authentication.
///     0x01 = Security Token. The format of the token and the way in which this token is obtained are
///         out of the scope of this document.
/// fFedAuthEcho: The intention of this flag is for the client to echo the server’s FEDAUTHREQUIRED
///     prelogin option, so that the server can validate that the response was not tampered with. The
///     client MUST assign this flag to 1 if and only if the server’s PRELOGIN response contained a
///     FEDAUTHREQUIRED option with a B_FEDAUTHREQUIRED value of 0x01.
/// FedAuthToken: The binary authentication token generated by the specified federated authentication
///     library. The length of FedAuthToken MUST NOT be 0.
