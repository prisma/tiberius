...
pub struct ClientBuilder {
    inner: tiberius::ClientBuilder<net::TcpStream, Client>,
}

impl convert::From<tiberius::ClientBuilder<net::TcpStream, Client>> for ClientBuilder {
    fn from(inner: tiberius::ClientBuilder<net::TcpStream, Client>) -> ClientBuilder {
        ClientBuilder { inner }
    }
}

impl convert::From<ClientBuilder> for tiberius::ClientBuilder<net::TcpStream, Client> {
    fn from(local_builder: ClientBuilder )-> tiberius::ClientBuilder<net::TcpStream, Client> {
        local_builder.inner
    }
}
...
fn connector(addr: String, instance_name: Option<String>) -> Pin<Box<dyn Future<Output = tiberius::Result<net::TcpStream>>>>
{
